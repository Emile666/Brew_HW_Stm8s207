/*==================================================================
  File Name: w5500.c
  Author   : WIZnet <support@wiznet.co.kr>; C-version by Emile
  ------------------------------------------------------------------
  Purpose  : This file contains the w5500 low-level routines
  ------------------------------------------------------------------
...
uint16_t w5500_write_socket_register(SOCKET s, uint8_t reg_name, uint8_t *buf) 
{
    ...
    switch (reg_name)
    {
        case Sn_MR:    case Sn_CR:  case Sn_IR:  case Sn_SR: 
        case Sn_PROTO: case Sn_TOS: case Sn_TTL: case Sn_RXBUF_SIZE: 
        case Sn_TXBUF_SIZE:
            len = 1; break;
        case Sn_DIPR: 
            len = 4; break;
